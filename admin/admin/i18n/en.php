...
define('ADMIN', 'Admin');
define('ADMIN_AUTHENTIFICATION_MODULE', 'The User Authentication Module');
define('ADMIN_AUTHENTIFICATION_MODULE_ENABLED', 'User Authentication Enabled');
define('ADMIN_AUTHENTIFICATION_MODULE_IS_ENABLED', 'The user authentication module is <span class="text-success-800">enabled</span>');
define('ADMIN_AUTHENTIFICATION_MODULE_DISABLED', 'User Authentication Disabled');
define('ADMIN_AUTHENTIFICATION_MODULE_IS_DISABLED', 'The user authentication module is  <span class="text-danger-800">disabled</span>');
...
define('COLUMN_INDEX', 'Column number');
...
define('EXPORT_CSV_BUTTON', '"Export button (xls / csv)"');
define('EXPORT_TO_CSV', 'Export to CSV format');
define('EXPORT_TO_EXCEL', 'Export to excel format');
define('EXPORT_TO_TSV', 'Export to TSV format');
...
define('HIDE', 'Hide');
define('HOME', 'Home');
define('HUMAN_READABLE_NAMES', 'Names Displayed in Admin');
define('IMAGE', 'Image');
...
define('INSTALL_ADMIN_AUTHENTIFICATION_MODULE', 'Install the User Authentication Module');
define('INSERT_SUCCESS_MESSAGE', '1 record added');
define('INVALID_CHARS_ERROR', 'The following %target_name% contain non-standard invalid characters:<br>%target_values%<br><br>You <strong>MUST</strong> change these names, or it\'ll break PHPCG functionnalities.<br><br>Allowed characters are: lowercase, uppercase, numbers and underscores. Numbers are not allowed as 1st character.<br><br><strong>Once done, click the "reload database structure" button.</strong>.');
define('LABEL', 'Label');
define('LIST_GENERATED', 'List generated');
define('LOADING_PLEASE_WAIT', 'Loading ... please wait');
define('LOGIN_ERROR', 'Authentification error');
...
define('MISSING_TABLE_IN_AUTHENTIFICATION_MODULE', 'The <strong>%TABLE%</strong> table is used in the admin panel but was not installed with the authentication module. <br> The authentication module must be reinstalled to add the <strong>%TABLE%</strong> table in profile rights management.');
...
define('OPEN_URL_BUTTON', 'Open URL button');
...
define('PHONE', 'Phone');
define('PRINTABLE_VIEW', 'Printable view');
...
define('RELOAD_DB_STRUCTURE', 'Reload database structure');
...
define('SIDE_BY_SIDE_COMPARISON_HELPER', 'Click on the parts you want to keep in the left and right columns, then <strong>"' . MERGE . '"</strong> to save your choices');
define('SIMPLE', 'Simple');
define('SINGLE', 'Unique');
define('SINGLE_ELEMENT_LIST', 'Single record list');
...
define('TIME_PLACEHOLDER', 'Time placeholder');
...
define('USER_MANAGEMENT_SUCCESSFULLY_CREATED', 'User management successfully created. You can now add/edit users &amp; profiles.<br><strong>Forms for deleting user and user profiles must be created using the CRUD Generator.</strong>');
define('USERS_TABLE_NAME', '<em class="text-primary">Users</em> table name');
...
$filter_help .= '<p class="alert alert-info has-icon">Use <a href="http://www.activedbsoft.com/overview-querytool.html" target="_blank">FlySpeed SQL Query</a> to generate and test your queries</p>';
...
define('ALLOW_CRUD_IN_LIST', 'Allow users to add/edit/delete records from the <strong>READ LIST</strong>');
...
<p><strong>Your navigation bar uses one or more tables whose structure needs to be regenerated.</strong></p>
<ol>
...
$users_profiles_helper .= '<p><code class="font-weight-bold">CURRENT_USER_ID</code> will be automatically replaced with the ID of the connected user.</p>';
$users_profiles_helper .= '<hr>';
$users_profiles_helper .= '<p>Your table <strong>MUST</strong> have <strong>direct or indirect</strong> relationship with <code class="font-weight-bold">' . $ut . '</code>. For example:</p>';
...
define('ADMIN_PANEL_SETTINGS_TXT', 'Admin Panel settings');
...
define('DEFAULT_BODY_CLASS_HELPER', 'Bootstrap CSS class for the admin panel body');
...
define('DEFAULT_PAGE_HEADER_HELPER', 'Bootstrap CSS class for the admin panel main header');
define('DEFAULT_PAGE_HEADER_TXT', 'Default main Header class');
define('DEFAULT_SIDEBAR_USER_HELPER', 'Bootstrap CSS class for the admin panel sidebar user section');
define('DEFAULT_SIDEBAR_USER_TXT', 'Default Sidebar User class');
...
define('GENERAL_SETTINGS_SUCCESS_MESSAGE', 'Your settings have been registered');
define('LANGUAGE_OTHER_HELPER', 'Enter your language ISO code and create your translation file in <span class="badge badge-light">admin\i18n\</span>');
...
define('MAIN_SETTINGS_TXT', 'Main settings');
