...
class ElementsFilters
{
    ...
    public function __construct($table, $filters, $join_query = '', $debug = false)
    {
        ...
        for ($i = 0; $i < $this->filters_count; $i++) {
            ...
            if (isset($_SESSION['filters-list'][$filter_var]) && $_SESSION['filters-list'][$filter_var] !== 'all') {
    ...
    public function returnForm($form_action, $use_restrictions = true)
    {
        ...
        if ($this->filters_count > 0) {
            ...
            for ($i = 0; $i < $this->filters_count; $i++) {
                ...
                /*if ($filter['filter_mode'] == 'simple') {
                    $qry_restriction = $this->join_query . $this->qry_restriction;
                }*/
                ...
                /*====================================================================================================================
                on récupère tous les filters, sauf celui du champ en cours (on filter la liste déroulante en fonction des autres champs,
    ...
    public function returnWhereQry($current_field = '')
    {
        ...
        foreach ($this->filters as $filter) {
            ...
            if (!isset($_SESSION['filters-list'][$field_var]) || (empty($_SESSION['filters-list'][$field_var]) && $_SESSION['filters-list'][$field_var] != 0)) {
