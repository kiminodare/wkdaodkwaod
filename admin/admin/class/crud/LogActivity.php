...
class LogActivity extends Elements
{
    ...
    public function __construct($element)
    {
        ...
        $qry_start        = 'SELECT `log_activity`.`id`, `log_activity`.`ip`, `log_activity`.`date`, `log_activity`.`history`, `log_activity`.`id_user` FROM log_activity';
