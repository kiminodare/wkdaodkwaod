...
class PhpcgUsers extends Elements
{
    ...
    public function __construct($element)
    {
        ...
        $qry_start        = 'SELECT `phpcg_users`.`ID`, `phpcg_users_profiles`.`profile_name` AS `phpcg_users_profiles_profile_name`, `phpcg_users`.`name`, `phpcg_users`.`firstname`, `phpcg_users`.`address`, `phpcg_users`.`city`, `phpcg_users`.`zip_code`, `phpcg_users`.`email`, `phpcg_users`.`phone`, `phpcg_users`.`mobile_phone`, `phpcg_users`.`password`, `phpcg_users`.`active` FROM phpcg_users';
        ...
        if (!empty($this->records_count)) {
            while (!$db->endOfSeek()) {
                ...
                $this->ID[]= $row->ID;
                $this->profiles_ID[]= $row->phpcg_users_profiles_profile_name;
                $this->name[]= $row->name;
