...
<div class="page-header <?php echo DEFAULT_HEADER_CLASS; ?> has-cover">
    ...
    <div class="d-flex align-items-center py-4 px-3">
        <a href="<?php echo ADMIN_URL . 'home'; ?>" title="<?php echo SITENAME ?>"><img src="<?php echo ADMIN_URL; ?>assets/images/<?php echo ADMIN_LOGO; ?>" alt="<?php echo SITENAME ?>"></a>
        <!-- /page title -->
            <h1 class="m-auto"><?php echo SITENAME ?></h1>
