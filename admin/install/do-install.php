        ...
        if ($already_registered === true) {
            ...
            if ($current_step == 2) {
                ...
                if ($db_info !== false) {
                    ...
                    $form->addHtml('<p><a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code" target="_blank" title="Where is my Purchase Code?">Where is my Purchase Code?</a></p>');
                    $form->endFieldset();
                ...
                $form->addHelper('If yes, the installer will add the tables and data from <a href="https://dev.mysql.com/doc/sakila/en/sakila-structure.html" target="_blank">Sakila Database</a> to your ' . DBNAME . ' database', 'install-demo-db', 'after');
            ...
            <div class="col-md-11 col-lg-10 mb-4">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <p class="lead text-center my-5"><a href="<?php echo GENERATOR_URL ?>generator.php" class="btn btn-primary" target="_blank">Open PHP Crud Generator Now<i class="<?php echo ICON_NEW_TAB; ?> ml-2"></i></a></p>
                        <?php
                        }
                        ?>
                    </div>
