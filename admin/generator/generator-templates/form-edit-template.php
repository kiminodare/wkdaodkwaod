...
<?php
    ...
    } elseif ($field_type == 'date' && $generator->columns['special3'][$i] > 0) {
?>
    $_SESSION['<?php echo $form_id; ?>']['<?php echo $column_name; ?>'] = date('Y-m-d');
<?php
    } elseif ($field_type == 'time' && $generator->columns['special3'][$i] > 0) {
?>
    $_SESSION['<?php echo $form_id; ?>']['<?php echo $column_name; ?>'] = date('H:i');
<?php
    } elseif ($field_type == 'month' && $generator->columns['special3'][$i] > 0) {
?>
...
$form->setAction('<?php echo ROOT_RELATIVE_URL . 'admin/' . $generator->item ?>/edit/' . $<?php echo $primary_key; ?>);
$form->startFieldset();
<?php
