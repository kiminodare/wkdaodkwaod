...
?>
                        ...
                        if (Secure::canUpdate('<?php echo $relation_table; ?>') === true || Secure::canCreate('<?php echo $relation_table; ?>') === true) {
                            ...
                            if (Secure::canUpdate('<?php echo $relation_table; ?>') === true) {
                                $action_btns  .= '<a href="<?php echo $relation_item; ?>/edit/' . $row-><?php echo $relation_table_pk_column; ?> . '" class="btn btn-xs btn-warning legitRipple" title="' . addslashes(EDIT) . '" data-popup="tooltip" data-delay="500"><span class="fas fa-pencil-alt"></span></a>';
                            }
                            if (Secure::canCreate('<?php echo $relation_table; ?>') === true) {
                                $action_btns  .= '<a href="<?php echo $relation_item; ?>/delete/' . $row-><?php echo $relation_table_pk_column; ?> . '" class="btn btn-xs btn-danger legitRipple" title="' . addslashes(DELETE_CONST) . '" data-popup="tooltip" data-delay="500"><span class="fas fa-times-circle"></span></a>';
                            }
                            $action_btns  .= '</div>';
