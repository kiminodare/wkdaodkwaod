            ...
            if ($tables_count > 0) {
                ...
                for ($i=0; $i < $tables_count; $i++) {
                    ...
                    if (!isset($db_data[$table]) || !isset($db_data[$table]['table_label'])) {
                        $list .= '<li class="child border d-flex justify-content-between bg-slate-100 px-1 py-1 m-1 disabled" id="' . $table . '"><span class="text-danger">' . $table . ':' . WRONG_TABLE_DATA . '<strong>*</strong></span></li>';
        ...
        <div class="row">
            <div class="col-md-12 my-5">
                ...
                <div class="card card-default">
                    <div class="card-header"><h4 class="card-title text-semibold mb-0"><?php echo ORGANIZE_ADMIN_NAVBAR; ?></h4></div>
                    <div class="card-body">
                        <div id="result"></div>
                        ...
                        if (DEMO === true) {
                            ?>
                                <div class="alert alert-info has-icon">
                                    <h4 class="mb-0">The Navbar module is disabled in this demo.</h4>
                                </div>
                            <?php
                        }
                        ?>
